...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserManagement.EFCore.Entities.RoleEntity", b =>
                {
            ...
            modelBuilder.Entity("UserManagement.EFCore.Entities.SecurityEventEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UserManagement.EFCore.Entities.UserEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UserManagement.EFCore.Entities.UserProfileEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UserManagement.EFCore.Entities.UserProfileEntity", b =>
                {
                    b.HasOne("UserManagement.EFCore.Entities.UserEntity", "User")
                        .WithOne("Profile")
                        .HasForeignKey("UserManagement.EFCore.Entities.UserProfileEntity", "UserId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("UserManagement.EFCore.Entities.RoleEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("UserManagement.EFCore.Entities.UserEntity", null)
                        .WithMany()
